...
int ledAzul= 10;              //Declara Pin LED Azul
int botonPin = 9;             //Declara Pin 9 digital entrada
int contador = 0;

void setup() // Se ejecuta cada vez que el Arduino se inicia
{
pinMode(ledRojo_RGB,OUTPUT);  //El RGB LED Rojo como una salida
pinMode(ledVerde_RGB,OUTPUT); //El RGB LED Verde como una salida
pinMode(ledAzul_RGB,OUTPUT);  //El RGB LED Azul como una salida
...
void color_RGB(int Rojo, int Azul,int Verde)
  {
    analogWrite(ledRojo_RGB, 255-Rojo);   //Escritura de RGB PWM del color_RGB Rojo
    analogWrite(ledVerde_RGB, 255-Verde); //Escritura de RGB PWM del color_RGB Verde
    analogWrite(ledAzul_RGB, 255-Azul);   //Escritura de RGB PWM del color_RGB Azul
