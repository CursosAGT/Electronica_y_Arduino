...
int botonPin = 9;  		//Declara Pin Boton
int contador = 0;
...
{
pinMode(ledRojo_RGB,OUTPUT);  	//El LED Rojo como una salida
pinMode(ledVerde_RGB,OUTPUT); 	//El LED Verde como una salida
pinMode(ledAzul_RGB,OUTPUT);	//El LED Azul como una salida
